                            ...
                            <form id="form_register" action="#">
                                ...
                                <div class="text-center">
                                    <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                                        <img src="{{ url('upload_file','user.jpg') }}" class="rounded-circle avatar-xl img-thumbnail user-profile-image material-shadow image-profile" alt="user-profile-image">
                                ...
                                <div class="mb-3">
                                    <label for="province_id" class="form-label">จังหวัดที่สมัคร</label>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="citizen_id" name="citizen_id" placeholder="กรุณาระบุเลขประจำตัวประชาชน">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="phone" placeholder="กรุณาระบุเบอร์โทรติดต่อ">
                                </div>


                                <div class="mb-3">
                                    <label for="email" class="form-label">Email (ใช้สำหรับเข้าสู่ระบบและรับข้อความทาง Email)</label>
                                    <input type="text" class="form-control" id="email" placeholder="กรุณาระบุ Email">
                                </div>
                                ...
                                <div class="mt-4">
                                    <button class="btn btn-success w-100" type="button" id="btn-register">สมัครสมาชิก</button>
                                </div>
